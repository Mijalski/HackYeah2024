...
const AchievementCount = () => {
  ...
  return (
    <div className="text-[#273237] flex px-4 py-2 rounded-md justify-center items-center space-x-4 text-2xl bg-bgPrimary select-none cursor-pointer w-32 sm:w-auto">
